					...
					<Grid container spacing={2}>
						<Grid item xs={12} sm={4}>
							<FormControl className={classes.feild}>
								<InputLabel id="category-search-select-label" className={classes.label}>Category</InputLabel>
								<Field
									component={Select}
									name="category"
									variant="filled"
						...
						<Grid item xs={12} sm={4}>
							<FormControl className={classes.feild}>
								<InputLabel id="tag-search-select-label" className={classes.label}>Tag</InputLabel>
								<Field
									component={Select}
									name="tag"
									variant="filled"
						...
						<Grid item xs={12} sm={4}>
							<FormControl className={classes.feild}>
								<InputLabel id="area-search-select-label" className={classes.label}>Area</InputLabel>
								<Field
									component={Select}
									name="area"
									variant="filled"
						...
						<Grid item xs={8} sm={4}>
							<FormControl className={classes.feild}>
								<InputLabel id="sortBy-search-select-label" className={classes.label}>Sort by</InputLabel>
								<Field
									component={Select}
									name="sortBy"
									variant="filled"
